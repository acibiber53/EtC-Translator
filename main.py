...
pyinstaller main.py -n EtC-translator-v0.95 --onefile --distpath EtC-translator-for-all-v0.95 --add-data venv/Lib/site-packages/google_api_python_client-1.12.8.dist-info;google_api_python_client-1.12.8.dist-info
